...
A local scan over markdown links in the restored corpus was used to verify internal relative links. Any broken links detected during refinement were repaired before publication.

## 2. Publication checklist

| Check | Status | Note |
| --- | --- | --- |
| Front door exists | pass | `docs/heavy_tech_documents/00_program/00_documentation_index_and_reading_guide.md` |
...
| Corpus manifest exists | pass | corpus inventory included |
...
| Repository corpus inventory present | pass | corpus manifest included |
