...
Start in `docs/05_operations/00_operator_quickstart_and_common_run_modes.md`.

### Where should a beginner start?
Start in `docs/01_foundations/00_foundations_learning_roadmap.md`.
...
3. `docs/05_operations/07_extension_safety_testing_and_change_protocol.md`
## Read next
