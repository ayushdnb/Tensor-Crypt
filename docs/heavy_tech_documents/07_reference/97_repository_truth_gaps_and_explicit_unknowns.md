...
The corpus is grounded in the checked-in repository tree, tests, scripts, and documentation. Remaining unknowns arise from conservative authorship policy rather than from missing repository access.
