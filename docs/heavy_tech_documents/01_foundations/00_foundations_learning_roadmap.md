...
- then jump to `docs/02_system` and `docs/03_mechanics`
...
After this layer:
- go to `docs/02_system/00_repository_identity_entry_surfaces_and_public_contract.md` for repository orientation
- go to `docs/03_mechanics/04_observation_schema_perception_and_ray_semantics.md` if the observation path is the main interest
- go to `docs/04_learning/00_learning_system_overview_and_data_ownership.md` if PPO ownership is the main interest
