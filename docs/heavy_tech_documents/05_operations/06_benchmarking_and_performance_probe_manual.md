...
> Scope: Explain the headless benchmark/probe workflow, what it measures, what its counters mean, and how not to over-interpret the results.
...
## 2. Inputs used by benchmark probes

The benchmark/probe configuration uses knobs for:
...
A benchmark/probe report writes or prints values including:
- elapsed seconds
- ticks per second
