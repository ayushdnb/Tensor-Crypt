...
- observation changes → observation docs, brain docs, PPO docs, checkpoint docs, glossary, tests
- family changes → bloodline docs, inference docs, checkpoint docs, viewer docs, tests
- registry changes → lifecycle docs, learning ownership docs, checkpoint docs, telemetry docs, tests
- respawn changes → reproduction docs, game manual, telemetry docs, validation docs, tests
- checkpoint changes → checkpoint docs, schema ledger, troubleshooting, validation docs, tests
